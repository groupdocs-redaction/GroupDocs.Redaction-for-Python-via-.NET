...
def run():
    ...
    print("\n[Example Basic Usage] # clean_metadata_with_filter.py : Clean filtered file metadata")
    ...
    met_red = grr.EraseMetadataRedaction(grr.MetadataFilters.AUTHOR  | grr.MetadataFilters.MANAGER)
